...
import upo.graph.impl.AdjMatrixDirWeight;

import static org.junit.jupiter.api.Assertions.*;

public class testDirWeight {
    ...
    void testGetWeight(){
        ...
        */
        WeightedGraph g1 = new AdjMatrixDirWeight();
        g1.addVertex("A");
        g1.addVertex("B");
        g1.addEdge("A", "B");
    ...
    void testDijkstra(){
         ...
         */
        WeightedGraph g2 = new AdjMatrixDirWeight();
        g2.addVertex("A");
        g2.addVertex("B");
        g2.addVertex("C");
        g2.addVertex("D");
        ...
        WeightedGraph g3 = new AdjMatrixDirWeight();
        g3.addVertex("A");
        g3.addVertex("B");
        g3.addVertex("C");
        g3.addEdge("A", "B");
        ...
        WeightedGraph g4 = new AdjMatrixDirWeight();
        g4.addVertex("A");
        g4.addVertex("B");
        g4.addVertex("C");
        g4.addVertex("D");
        ...
        WeightedGraph g5 = new AdjMatrixDirWeight();
        g5.addVertex("A");
        g5.addVertex("B");
        g5.addVertex("C");
        g5.addVertex("D");
